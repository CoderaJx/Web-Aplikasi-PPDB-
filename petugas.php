...
<div class="wrapper">
                ...
                <nav class="navbar navbar-expand navbar-primary navbar-dark">
                  ...
                  <!-- SEARCH FORM -->
                  <form action="petugas.php" method="get">
...
if (isset($_GET['cari'])){
 ...
 ?>
<a href="tambah-petugas.php ?>">Tambah</a>
 <?php 
 ...
 if (isset($_GET['pesan'])) {
   if ($_GET['pesan']=="edit") {
     echo "
     <script>
     alert('Petugas Berhasil Di Edit');
     </script>
     ";
...
if (isset($_GET['cari'])){
$cari=$_GET['cari'];
$c=mysqli_query($koneksi,"SELECT * FROM petugas where nama_petugas like '%$cari%'");
...
while($d =mysqli_fetch_array($c)){
  ...
  <tr>
    ...
    <td>
      <a href="edit-petugas.php?id_petugas=<?php echo $d['id_petugas']; ?>">Edit</a>
      <a href="hapus-petugas.php?id_petugas=<?php echo $d['id_petugas']; ?>">Hapus</a>
